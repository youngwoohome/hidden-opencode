export namespace Flag {
  ...
  export const OPENCODE_SESSION_CONCURRENCY_MAX = number("OPENCODE_SESSION_CONCURRENCY_MAX")
  export const OPENCODE_USER_SESSION_CONCURRENCY_MAX = number("OPENCODE_USER_SESSION_CONCURRENCY_MAX")
  ...
  export const OPENCODE_EXPERIMENTAL_NETWORK_GATING =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_NETWORK_GATING")
  export const OPENCODE_EXPERIMENTAL_SPAWN_WORKTREE =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_SPAWN_WORKTREE")
  export const OPENCODE_EXPERIMENTAL_SPAWN_MAX_CHILDREN = number("OPENCODE_EXPERIMENTAL_SPAWN_MAX_CHILDREN")
  export const OPENCODE_EXPERIMENTAL_OUTPUT_TOKEN_MAX = number("OPENCODE_EXPERIMENTAL_OUTPUT_TOKEN_MAX")
  export const OPENCODE_EXPERIMENTAL_OXFMT = OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_OXFMT")
  export const OPENCODE_EXPERIMENTAL_LSP_TY = truthy("OPENCODE_EXPERIMENTAL_LSP_TY")
  export const OPENCODE_EXPERIMENTAL_LSP_TOOL = OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_LSP_TOOL")
  export const OPENCODE_EXPERIMENTAL_CLOSED_LOOP =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_CLOSED_LOOP")
  export const OPENCODE_EXPERIMENTAL_CLOSED_LOOP_COMMANDS = process.env["OPENCODE_EXPERIMENTAL_CLOSED_LOOP_COMMANDS"]
